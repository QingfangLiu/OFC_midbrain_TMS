...
## read source data
UseAggBOLD = read.xlsx(file.path(usedir,'SourceData.xlsx'),'EDFig5d-1')
UseDiffAggBOLD = read.xlsx(file.path(usedir,'SourceData.xlsx'),'EDFig5d-2')
...
pdf(file.path(figDir,'EDFig5d.pdf'),8,4)
