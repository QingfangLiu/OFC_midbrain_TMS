...
SCdat = read.xlsx(file.path(usedir,'SourceData.xlsx'),'EDFig1')

# this only contains 31 subjects
...
pdf(file.path(figDir,'EDFig1.pdf'), 9, 12)
fig = ggarrange(p[[1]], p[[2]], p[[3]], p[[4]], p[[5]], p[[6]],
                  ncol = 2, nrow = 3, 
