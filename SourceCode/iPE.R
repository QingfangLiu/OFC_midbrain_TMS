...
UseAggBOLD = read.xlsx(file.path(usedir,'SourceData.xlsx'),'Fig5bEDFig5c')
UseDiffAggBOLD = read.xlsx(file.path(usedir,'SourceData.xlsx'),'Fig5cEDFig5b')
...
pdf(file.path(figDir,'EDFig5c.pdf'),8,4)
...
pdf(file.path(figDir,'EDFig5b.pdf'),4.5,4)
print(p)
dev.off()
