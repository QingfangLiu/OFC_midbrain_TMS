...
## read source data
UseAggBOLD = read.xlsx(file.path(usedir,'SourceData.xlsx'),'EDFig6a')
UseDiffAggBOLD = read.xlsx(file.path(usedir,'SourceData.xlsx'),'EDFig6b')
...
pdf(file.path(figDir,'EDFig6.pdf'),14,6)
