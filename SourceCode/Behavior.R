...
AllRevdf = read.xlsx(file.path(usedir,'SourceData.xlsx'),'Fig4ab')
AggSimudf = read.xlsx(file.path(usedir,'SourceData.xlsx'),'Fig4c')
df_mu = read.xlsx(file.path(usedir,'SourceData.xlsx'),'Fig4d')
alpha_beh = read.xlsx(file.path(usedir,'SourceData.xlsx'),'Fig4e')
...
pdf(file.path(figDir,'Fig4.pdf'), 8, 12)
